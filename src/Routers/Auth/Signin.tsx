...
export default function Signin() {
  return (
    <>
      <div className="main__signin__container">
              ...
              <div className="col-sm-4">
                <div className="card mb-2">
                  <div className="card-body">
                    ...
                    <div className="alert alert-danger"><p>Исправьте следующие ошибки:</p><ul></ul></div>                    <div className="form-group field-loginform-identity required">
                    ...
                    </div>                    <div className="form-group field-loginform-password required">
                      <label >Пароль</label>
